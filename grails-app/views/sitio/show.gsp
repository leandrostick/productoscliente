...
<html>
    ...
    <body>
        ...
        <div id="show-sitio" class="content scaffold-show" role="main">
            ...
            <f:display bean="sitio" />
            <g:form resource="${this.sitio}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.sitio}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
